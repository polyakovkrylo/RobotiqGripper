...
// Modbus CRC16 calculation routine
// Refer to https://modbus.org/docs/Modbus_over_serial_line_V1_02.pdf
...
unsigned short сhecksum (char *message, unsigned short length )
{
    ...
    while (length--) {
        index = highByte ^ static_cast<unsigned char>(*message++);
